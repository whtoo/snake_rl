...
class NoisyLinear(nn.Module):
    ...
    def sample_noise(self):
        ...
        if self.factorised:
            ...
            # 独立噪声
            self.epsilon_weight.data = torch.randn(self.out_features, self.in_features, device=device)
            self.epsilon_bias.data = torch.randn(self.out_features, device=device)
